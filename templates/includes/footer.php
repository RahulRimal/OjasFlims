                        ...
                        <div class="footer-widget">
                            <div class="text-left">
                                <div class="widget-heading">
                                    <h3 style="color: var(--primary-color); font-weight: bold;">Ojas Flims</h3>
                                </div>
                            ...
                            <div class="text-left">
                                ...
                                <div class="widget-body">
                                    <ul class="d-flex justify-content-start">
                                        ...
                                        <li>
                                            <a href="#"><i style="font-size: 30px" class="fa fa-twitter pe-3"
                                                    aria-hidden="true"></i></a>
                                        </li>
                                        <li>
                                            <a href="#"><i style="font-size: 30px" class="fa fa-instagram"
                                                    aria-hidden="true"></i></a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="footer-copyright">
                            <p class="m-0">
                                ...
                                |
                                <strong>Ojas Flims</strong>. All Rights Reserved
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 text-center text-md-end">
                        <div class="footer-credit">
                            <p class="m-0">
                                By <strong>genuinetechnology</strong>
                            </p>
                        </div>
                    </div>
                </div>
